				...
				$.each(data,function(i,item){
					...
					$.each(item.files,function(n,file){
						if(file.fileType=='DIR'){
							...
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/txt.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='MP3'||file.fileType=='WMA'||file.fileType=='WAV'||file.fileType=='MOD'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/music.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='HTML'||file.fileType=='HTM'||file.fileType=='JSP'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/html.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='RAR'||file.fileType=='JAR'||file.fileType=='ZIP'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/zip.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='DOC'||file.fileType=='WPS'||file.fileType=='DOCX'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/word.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='XLS'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/excel.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='PPT'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/ppt.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='EXE'||file.fileType=='BAT'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/exe.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='BMP'||file.fileType=='PNG'||file.fileType=='GIF'||file.fileType=='JPEG'||file.fileType=='JPG'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"  class="downLoad" id="file_'+n+'"><img src="images/photo.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else if(file.fileType=='RMVB'||file.fileType=='MKV'||file.fileType=='MP4'||file.fileType=='AVI'||file.fileType=='WMV'||file.fileType=='3GP'){
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"   class="downLoad" id="file_'+n+'"><img src="images/movie.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
						else{
							$('#showContent').append('<div class="fileDetail"><a href="javascript:void(0);"   class="downLoad" id="file_'+n+'"><img src="images/config.png" title="大小：'+file.fileSize+'&#10;'+file.fileName+'"/><span>'+file.fileName+'</span><input type="hidden" value='+file.filePath+'/></a></div>');
						}
					});
				});
			}
