...
<div class="page-header" style="padding:10px 20px;margin:-18px 0px 0px">
  <div id="searchForm">
		<div class="col-md-1" style="width: 200px">
			<input type="text" class="form-control search-query" name="companyName" placeholder="保险公司">
		</div>
		<div class="col-md-1"  style="width: 200px">
	    ...
	    <div class="col-md-1"  style="width: 156px;">
	        <button id="addBtn" class="btn btn-labeled btn-primary"  onclick="javascript:showModal('添加保险产品', 'bx/pd/addPage',750);"><span class="btn-label icon fa fa-plus"></span>添加保险产品</button>
	    </div>
  </div>
</div>
    ...
    $(function (){
        $("#openAppGrid").sgrid({
            columns:[
                ...
                {field:"companyName", text:"保险公司"},
                {field:"productCode", text:"险种代码"},
                ...
                {field:"pic_2", text:"列表图片",style:"text-align:center;width:80px;height:80px;", formatter:function(index, content, data){
                	 var imgPath="${basePath}"+content;
                    return "<img src="+imgPath+" class='thumbnail' onerror=\"javascript:this.src='${basePath}h5/res/images/_sample_bx_squre.jpg';\" style=\"width: 100%;height: 100%;\"/>";
            	  }},
                ...
                {field:"id", text:"操作",style:"text-align:center", formatter:function(index, content, data){
	                    ...
	                    if(data.status==1){
	                    	 ...
	                    	 return	"<a href='javascript:showCfm(\"下架\", \""+publishStatusUrl+"\");' class='btn btn-xs btn-success'><i class='ace-icon fa fa-download'>下架</i></a>"
	                    		+ "&nbsp;<a href='javascript:showModal(\"更新保险公司\", \""+editUrl+"\",750);' data-original-title='修改' class='btn btn-xs btn-warning add-tooltip'><i class='fa fa-pencil'>修改</i></a>"
