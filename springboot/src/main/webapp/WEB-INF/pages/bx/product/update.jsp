...
<form id="submitForm" class="form-horizontal"  > 
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input class="form-control" type="text" id="url_1" name="url_1"  value="${product.url_1}"
				placeholder="详情页地址" />
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-10">
			<input class="form-control" type="text" id="url_2" name="url_2"  value="${product.url_2}"
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input class="form-control" type="text" id="url_3" name="url_3"  value="${product.url_3}"
				placeholder="理赔地址" />
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-10">
			<input class="form-control" type="text" id="url_4" name="url_4"  value="${product.url_4}"
				placeholder="保单电子版地址" />
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-4">
			 <input id="pic_2" name="pic_2" type="file" data-show-caption="true">  
              <p class="help-block">支持jpg、jpeg、png格式，大小不超过1.0M</p>  
              	<input type="hidden" id="pic_2_hidden" name="pic_2_hidden"    value="${product.pic_2}"  />
		</div>
	</div>
</form>
