...
public class BXCompanyController extends BaseController {
	...
	@Authority(opCode = "0201", opName = "保险公司界面")
	@RequestMapping("mainPage")
	public String mainPage() {
		return "bx/company/main";
	}

	@RequestMapping("queryPage")
	@ResponseBody
	@Authority(opCode = "0201", opName = "查询保险公司列表")
	public PageAjax<BXCompany> queryPage(PageAjax<BXCompany> page, BXCompany bean) {
		bean.setEnabled("1");
		return bxCompanyService.queryPage(page, bean);
	}

	@Authority(opCode = "020101", opName = "添加保险公司")
	@RequestMapping("addPage")
	public String addPage() {
		return "bx/company/add";
	}

	@ControllerLog("添加保险公司")
	@RequestMapping("add")
	@ResponseBody
	@Authority(opCode = "020101", opName = "添加保险公司")
	...
	@Authority(opCode = "020102", opName = "修改保险公司页面")
	...
	public String updatePage(@PathVariable("id") int id, Map<String, Object> map) {
		...
		return "bx/company/update";
	}

	@ControllerLog("修改保险公司")
	@RequestMapping("update")
	@ResponseBody
	@Authority(opCode = "020102", opName = "修改保险公司")
	...
	@ControllerLog("删除保险公司")
	@RequestMapping("deleteByID/{id}")
	@ResponseBody
	@Authority(opCode = "010203", opName = "删除保险公司")
