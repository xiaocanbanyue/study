...
public class BXClassifyController extends BaseController {
	...
	@Authority(opCode = "0202", opName = "保险产品分类界面")
	...
	@ResponseBody
	@Authority(opCode = "0202", opName = "查询保险产品分类列表")
	...
	@Authority(opCode = "020201", opName = "添加保险产品分类")
	@RequestMapping("addPage")
	public String addPage() {
		return "bx/class/add";
	}

	@ControllerLog("添加保险产品分类")
	@RequestMapping("add")
	@ResponseBody
	@Authority(opCode = "020201", opName = "添加保险产品分类")
	...
	@Authority(opCode = "020202", opName = "修改保险产品分类页面")
	...
	@ControllerLog("修改保险产品分类")
	@RequestMapping("update")
	@ResponseBody
	@Authority(opCode = "020202", opName = "修改保险产品分类")
	...
	@ControllerLog("删除保险产品分类")
	@RequestMapping("deleteByID/{id}")
	@ResponseBody
	@Authority(opCode = "020203", opName = "删除保险产品分类")
