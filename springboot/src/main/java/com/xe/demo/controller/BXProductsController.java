...
public class BXProductsController extends BaseController {
	...
	@Authority(opCode = "0401", opName = "保险产品管理界面")
	...
	public String mainPage(Map<String, Object> map) {
		...
		return "bx/product/main";
	}

	@RequestMapping("queryPage")
	@ResponseBody
	@Authority(opCode = "0401", opName = "查询保险产品列表")
	...
	@Authority(opCode = "040101", opName = "添加保险产品界面")
	...
	@ControllerLog("添加保险产品")
	@RequestMapping("add")
	@ResponseBody
	@Authority(opCode = "040102", opName = "添加保险产品")
...
//        String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/upload/";
	...
	@Authority(opCode = "040101", opName = "修改保险产品页面")
	...
	public String updatePage(@PathVariable("id") int id, Map<String, Object> map) {
		...
		return "bx/product/update";
	}

	@ControllerLog("修改保险产品")
	@RequestMapping("update")
	@ResponseBody
	@Authority(opCode = "040102", opName = "修改保险产品")
	...
	@ControllerLog("删除保险产品")
	@RequestMapping("deleteByID/{id}")
	@ResponseBody
	@Authority(opCode = "0407", opName = "删除保险产品")
